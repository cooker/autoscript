...
[task_local]
#贝瑞咖啡签到
30 7 * * 1,3,5 https://raw.githubusercontent.com/cooker/autoscript/brapp_sign.js, tag=众筹许愿池, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "30 7 * * 1,3,5" script-path=https://raw.githubusercontent.com/cooker/autoscript/brapp_sign.js,tag=贝瑞咖啡签到

===============Surge=================
贝瑞咖啡签到 = type=cron,cronexp="30 7 * * 1,3,5",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/cooker/autoscript/brapp_sign.js

============小火箭=========
贝瑞咖啡签到 = type=cron,script-path=https://raw.githubusercontent.com/cooker/autoscript/brapp_sign.js, cronexpr="30 7 * * 1,3,5", timeout=3600, enable=true
 */
const $ = new Env('贝瑞咖啡签到');
...
let appNameArr = ['贝瑞咖啡签到', '1111点心动','冰雪闪耀季'];
let appId, appName;
$.shareCode = [];
if ($.isNode()) {
